...
export default function EducationalMockupPage() {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <Link href="/e-poster/educational/review">
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>Post Preview — @{data.portfolioUsername}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                This is how the post will appear on the eToro feed.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="mb-6 bg-gray-50 rounded-xl p-6">
            <EtoroPostMockup
              username={data.portfolioUsername}
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-muted-foreground">
              ...
              {postStatus === 'failed' && postError && (
                <span className="text-red-600">{postError}</span>
              )}
            </div>
